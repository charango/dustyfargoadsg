...
InitVariables()
{
  ...
  var("INDIRECTTERMSMOOTHING", &INDIRECTTERMSMOOTHING, REAL, NO, "0.0");
  ...
  var("ALTERNATIVEGASINDIRECTTERM", ALTERNATIVEGASINDIRECTTERM, STRING, NO, "NO");  
  ...
  var("WAVEKILLINGZONES", WAVEKILLINGZONES, STRING, NO, "NO");
  var("DAMPINGTODYNAMICALTIMERATIO", &DAMPINGTODYNAMICALTIMERATIO, REAL, NO, "0.3");
  ...
  var("REMOVEDUSTFROMPLANETSHILLRADIUS", REMOVEDUSTFROMPLANETSHILLRADIUS, STRING, NO, "NO");
  ...
  var("ZEROVRADBC", ZEROVRADBC, STRING, NO, "NO");
}
